      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 h-full flex flex-col justify-center">
        <div className="max-w-2xl animate-fade-in">
          <h1 className="text-4xl md:text-5xl lg:text-6xl text-white font-bold leading-tight mb-6">
            Trouvez votre résidence de rêve avec Élégant Demeures
          </h1>
          <p className="text-lg md:text-xl text-white/90 mb-8">
            Notre agence immobilière d'exception vous accompagne dans tous vos projets, des biens les plus raffinés aux propriétés de caractère.
          </p>
